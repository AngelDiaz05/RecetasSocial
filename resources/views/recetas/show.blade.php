...
<div class="receta-meta mt-3">
    ...
    <p>
        ...
        <a class="text-dark" href="{{route('perfiles.show',['perfil' => $receta->autor->id])}}">
            {{--autor es la relacion que se creo en Receta , y nombre es la fila de la tabla donde se encuenta el nombre del usuario que creo la receta--}}
            {{$receta->autor->name}}
        </a>
    </p>
    ...
    <p>
        ...
        @endphp
        {{-- Mandamos la fecha por medio de props a Vuejs --}}
